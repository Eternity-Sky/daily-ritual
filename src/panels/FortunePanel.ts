...
export class FortunePanel {
    public static currentPanel: FortunePanel | undefined;
    public static readonly viewType = 'daily-ritual.fortune';
    ...
    public static createOrShow(extensionUri: vscode.Uri, storageManager: StorageManager) {
    ...
    private constructor(panel: vscode.WebviewPanel, extensionUri: vscode.Uri, storageManager: StorageManager) {
        this._panel = panel;
